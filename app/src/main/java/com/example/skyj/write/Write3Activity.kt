...
import kotlinx.android.synthetic.main.activity_write3.*
import java.text.SimpleDateFormat
import java.util.*

class Write3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_write3)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode==PICK_IMAGE_FROM_ALBUM){
            if(resultCode== Activity.RESULT_OK){
                ...
                photoUri=data?.data
                post3_img.setImageURI(photoUri)
        ...
        storageRef?.putFile(photoUri!!)?.addOnSuccessListener {
            ...
            storageRef.downloadUrl
                .addOnSuccessListener {uri ->
                    ...
                    contentDTO.text=post3_content.text.toString()
                    contentDTO.title=post3_title.text.toString()
                    contentDTO.timestamp=System.currentTimeMillis()

                    db.collection("contest_postInfo")?.document()?.set(contentDTO)
                    ...
                    docRef.get()
                        .addOnSuccessListener { documentSnapshot ->
                            ...
                            db.collection("contest_post_writerInfo")?.document()?.set(contentWriterDTO)
                        }
                }
        }
