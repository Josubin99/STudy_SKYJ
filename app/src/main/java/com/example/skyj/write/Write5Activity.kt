...
import kotlinx.android.synthetic.main.activity_write5.*
import java.text.SimpleDateFormat
import java.util.*

class Write5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_write5)
        ...
        storageRef?.putFile(photoUri!!)?.addOnSuccessListener {
            ...
            storageRef.downloadUrl
                .addOnSuccessListener {uri ->
                    ...
                    db.collection("ncs_postInfo")?.document()?.set(contentDTO)
                    ...
                    docRef.get()
                        .addOnSuccessListener { documentSnapshot ->
                            ...
                            db.collection("ncs_post_writerInfo")?.document()?.set(contentWriterDTO)
                        }
                }
        }
