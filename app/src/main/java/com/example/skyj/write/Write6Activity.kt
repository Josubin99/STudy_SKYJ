...
import kotlinx.android.synthetic.main.activity_write6.*
import java.text.SimpleDateFormat
import java.util.*

class Write6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_write6)
        ...
        storageRef?.putFile(photoUri!!)?.addOnSuccessListener {
            ...
            storageRef.downloadUrl
                .addOnSuccessListener {uri ->
                    ...
                    db.collection("engineer_postInfo")?.document()?.set(contentDTO)
                    ...
                    docRef.get()
                        .addOnSuccessListener { documentSnapshot ->
                            ...
                            db.collection("engineer_post_writerInfo")?.document()?.set(contentWriterDTO)
                        }
                }
        }
