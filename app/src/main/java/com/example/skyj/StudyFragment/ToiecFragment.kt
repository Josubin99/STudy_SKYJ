...
import com.example.skyj.write.Write3Activity
import com.example.skyj.write.Write4Activity
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import kotlinx.android.synthetic.main.fragment_interview.view.*

class ToiecFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View= inflater.inflate(R.layout.fragment_toiec, container, false)
        ...
        db.collection("toiec_post_writerInfo")
            .orderBy("timestamp")
            .get()
            .addOnSuccessListener { result->
                for(document in result) {
        ...
        view.write_button.setOnClickListener {
            ...
            if(auth.currentUser==null){
                ...
                val intent = Intent(requireContext(), Write4Activity::class.java)
                startActivity(intent)
