...
import kotlinx.android.synthetic.main.fragment_interview.view.post_listview
import kotlinx.android.synthetic.main.fragment_interview.view.write_button
import kotlinx.android.synthetic.main.fragment_opic.view.*

class OpicFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View= inflater.inflate(R.layout.fragment_opic, container, false)
        ...
        db.collection("opic_post_writerInfo")
            .orderBy("timestamp")
            .get()
            .addOnSuccessListener { result->
                for(document in result) {
