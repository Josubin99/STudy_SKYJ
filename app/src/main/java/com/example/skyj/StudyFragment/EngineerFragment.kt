...
import com.example.skyj.write.Write6Activity
...
class EngineerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View= inflater.inflate(R.layout.fragment_engineer, container, false)
        ...
        db.collection("engineer_postInfo")
            .orderBy("timestamp")
            .get()
        ...
        db.collection("engineer_post_writerInfo")
            .orderBy("timestamp")
            .get()
            .addOnSuccessListener { result->
                for(document in result) {
        ...
        view.write_button.setOnClickListener {
            ...
            if(auth.currentUser==null){
                ...
                val intent = Intent(requireContext(), Write6Activity::class.java)
                startActivity(intent)
