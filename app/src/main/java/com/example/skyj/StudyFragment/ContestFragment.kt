...
class ContestFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View= inflater.inflate(R.layout.fragment_contest, container, false)
        ...
        db.collection("contest_postInfo")
            .orderBy("timestamp")
            .get()
        ...
        db.collection("contest_post_writerInfo")
            .orderBy("timestamp")
            .get()
            .addOnSuccessListener { result->
                for(document in result) {
        ...
        view.write_button.setOnClickListener {
            ...
            if(auth.currentUser==null){
                ...
                val intent = Intent(requireContext(), Write3Activity::class.java)
                startActivity(intent)
